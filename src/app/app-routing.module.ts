...
const routes: Routes = [                                   
  ...
  { path: 'GetOwners', component: OwnersComponent, canActivate: [AdminGuard,UserGuard] },
  { path: 'OwnerPost', component: OwnerpostComponent, canActivate: [AllowAllGuard] },
  { path: 'OwnerPut', component: OwnerputComponent, canActivate: [AllowAllGuard] },
  { path: 'OwnerDelete', component: OwnerdeleteComponent, canActivate: [AllowAllGuard]},
  ...
  { path: 'DeleteRepair', component: RepairdeleteComponent, canActivate: [AllowAllGuard] },
